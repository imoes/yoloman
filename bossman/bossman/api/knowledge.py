...
_SYS_ASK = (
    ...
    "explicitly. If a failure lines up in time with a recent change (a runbook run / "
    "apply) or a recent event on that host, call out that the change is the likely "
    "cause. Then propose concrete next actions the operator can take in Bossman "
